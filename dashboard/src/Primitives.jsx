...
export function Icon({ name, size = 24, stroke = 2, style, className }) {
  const paths = {
    ...
    whatsapp: <><path d="M12 3.2a8.8 8.8 0 0 0-7.5 13.4l-1.3 4.2 4.3-1.3A8.8 8.8 0 1 0 12 3.2z"/><path fill="currentColor" stroke="none" transform="translate(1.4 -0.1)" d="M9.7 7.9c-.2-.4-.4-.4-.6-.4h-.5c-.2 0-.5.1-.7.3-.3.3-1 .9-1 2.2 0 1.3 1 2.6 1.1 2.7.1.2 1.9 3 4.7 4.1.6.3 1.1.4 1.5.5.6.2 1.2.2 1.6.1.5-.1 1.5-.6 1.7-1.2.2-.6.2-1.1.2-1.2-.1-.1-.2-.2-.5-.3-.3-.1-1.5-.7-1.7-.8-.2-.1-.4-.1-.6.1-.2.2-.6.8-.8 1-.1.1-.3.2-.5.1-.4-.2-1.1-.5-2-1.3-.7-.7-1.2-1.4-1.4-1.7-.1-.2 0-.4.1-.5.1-.1.2-.3.4-.4.1-.1.2-.3.2-.4.1-.1 0-.3 0-.4 0-.1-.5-1.4-.7-1.9z"/></>,
